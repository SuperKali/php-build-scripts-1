...
set PHP_VER=%PHP_MAJOR_VER%.0alpha3
set PHP_IS_BETA=yes
...
set PHP_PTHREADS_VER=fe21371ea510bf34dfa26159311aed15d643cd91
set PHP_YAML_VER=9323bf648fa8f6f029e508d7820a5bafeec7d64c
